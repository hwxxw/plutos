              ...
              >
                {app.slug ? (
                  <Link
                    ...
                    style={{ backgroundColor: '#0d0d14', border: '1px solid #2a1515' }}
                    onMouseEnter={(e) => {
                  ...
                  <div className="flex-shrink-0 w-44 rounded-2xl p-3 cursor-default"
                    style={{ backgroundColor: '#0d0d14', border: '1px solid #2a1515' }}>
                    <AppCardInner app={app} />
                  </div>
                )}
...
function AppCardInner({ app }: { app: AdApp }) {
  return (
    <>
      {app.icon_url ? (
      ...
      <div className="font-semibold text-xs truncate mb-0.5" style={{ color: '#f0ece4' }}>
        {app.name}
      </div>
      <div className="text-[10px] line-clamp-2 leading-tight mb-2" style={{ color: '#4a3535' }}>
        {app.tagline || ''}
      </div>
